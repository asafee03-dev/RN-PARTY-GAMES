...
כאשר יש "מילת זהב" או בסיום הזמן ישמע צליל ובמידה וקבוצה עדיין לא סיימה לנחש מילה, שאר הקבוצות יכולות גם לנחש ולזכות בנקודה.
...
לאחר מכן התור עובר לשחקן הבא, והמשחק נמשך עד שאחד השחקנים מגיע ל12 נקודות`,
  },
};
